  ...
  return <div>
     <div className="card">
                ...
                <div className="mb-3 row">
                    ...
                    <div className="col-sm-6">
                    <input type="text"  className="form-control-plaintext" id="staticEmail" placeholder="+91 8301868891"/>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Profile Picture</label>
                    <div className="col-sm-6">
                    <input type="file"  className="form-control-plaintext" id="staticEmail" />
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Bio Details</label>
                    <div className="col-sm-6">
                    <textarea row="4" type="text"  className="form-control-plaintext" id="staticEmail" placeholder="Enter Here"/>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Interests</label>
                    <div className="col-sm-6">
                    <textarea row="4" type="text"  className="form-control-plaintext" id="staticEmail" placeholder="Python, React, Java..."/>
                    </div>
                </div>
                ...
                <div className="mb-3 row">
                    ...
                    <div className="col-sm-10">
                    <input type="text"  className="form-control-plaintext" id="staticEmail" placeholder="STATE BANK OF INDIA"/>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Acc Number</label>
                    <div className="col-sm-10">
                    <input type="text"  className="form-control-plaintext" id="staticEmail" placeholder="20366820222"/>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="staticEmail" className="col-sm-2 col-form-label">IFSC Code</label>
                    <div className="col-sm-10">
                    <input type="text"  className="form-control-plaintext" id="staticEmail" placeholder="SBIN0002207"/>
                    </div>
                </div>
